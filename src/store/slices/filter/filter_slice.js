...
export const filter_slice = createSlice({
    name: 'filter',
    initialState: {
        status: 'false', //open - not-open - checking
        filter_properties:  {   

            serviceType:['Arriendo','Compra','Venta'],
            departmentType:['Departamento','Casa','Oficina'],
            region:[
                    {
...
export const { changeState } = filter_slice.actions;